# Shipping profiles for subscriptions

You can create multiple shipping profiles in Skio to manage shipping for different subscription types. Each shipping profile can be assigned to specific selling plan groups, giving you more control over how shipping is calculated for your subscription products. New products added to a selling plan group automatically update the associated shipping profile.

**On this page**
- Set up a shipping profile
...
On the Shipping page, click **+ Create new profile** in the top-right corner.
...
Click **Create profile** to save your changes.
...
Scroll down to the **Select a source shipping profile from Shopify** section.
...
Click **Save changes** to finalize your shipping profile settings.

If necessary, click **Resync shipping** at the top-right to manually apply updates.

**Note:** All shipping profile updates must be made directly in Shopify. To access Skio-specific shipping profiles, go to **Settings > Shipping and Delivery > View Profile** in your Shopify admin.
...
**Automation:** New products added to a selling plan group automatically update the associated shipping profile, reducing manual effort.
